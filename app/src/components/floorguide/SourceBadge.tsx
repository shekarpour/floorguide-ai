...
> = {
  safety: {
    ...
    short: "Safety",
    icon: ShieldCheck,
    className: "bg-safety-muted text-safety-foreground border-safety/30",
  },
  maintenance: {
    label: "Maintenance Manuals",
    short: "Maintenance",
    icon: Wrench,
    className: "bg-maintenance-muted text-maintenance border-maintenance/20",
  },
  quality: {
    label: "Quality Standards",
    short: "Quality",
    icon: CheckCircle2,
    className: "bg-quality-muted text-quality-foreground border-quality/25",
  },
};
...
export function SourceBadge({
  ...
  return (
    <span
      className={cn(
        "inline-flex items-center gap-1.5 rounded-md border px-2 py-1 text-[11px] font-semibold uppercase tracking-[0.04em]",
        cfg.className,
        className,
      )}
    >
