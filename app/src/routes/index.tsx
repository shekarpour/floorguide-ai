...
function Index() {
  ...
  useEffect(() => {
    ...
    const timers = WORKFLOW_STAGES.map((_, i) => setTimeout(() => setStage(i), i * 4000));
    ...
    <div className="relative flex min-h-screen flex-col bg-surface">
      ...
      <footer className="border-t border-hairline">
        <p className="mx-auto max-w-6xl px-5 py-4 text-center text-[11px] text-muted-foreground md:px-8">
          Demo with fictional Northstar Foods documentation — confirm critical actions with approved
          plant procedures.
        </p>
      </footer>
    </div>
